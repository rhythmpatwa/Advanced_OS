	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 a8 22 80 00 	movsbl 0x8022a8(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 e0 23 80 00 	jmp    *0x8023e0(,%eax,4)
  ...
  8003af:	8b 14 85 40 25 80 00 	mov    0x802540(,%eax,4),%edx
  8003b6:	85 d2                	test   %edx,%edx
  8003b8:	75 18                	jne    8003d2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ba:	50                   	push   %eax
  8003bb:	68 c0 22 80 00       	push   $0x8022c0
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 75 26 80 00       	push   $0x802675
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 b9 22 80 00       	mov    $0x8022b9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a92:	68 9f 25 80 00       	push   $0x80259f
  800a97:	6a 23                	push   $0x23
  800a99:	68 bc 25 80 00       	push   $0x8025bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b13:	68 9f 25 80 00       	push   $0x80259f
  800b18:	6a 23                	push   $0x23
  800b1a:	68 bc 25 80 00       	push   $0x8025bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800cc1:	68 9f 25 80 00       	push   $0x80259f
  800cc6:	6a 23                	push   $0x23
  800cc8:	68 bc 25 80 00       	push   $0x8025bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dce:	ba 48 26 80 00       	mov    $0x802648,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800df9:	51                   	push   %ecx
  800dfa:	50                   	push   %eax
  800dfb:	68 cc 25 80 00       	push   $0x8025cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801023:	53                   	push   %ebx
  801024:	50                   	push   %eax
  801025:	68 0d 26 80 00       	push   $0x80260d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010f8:	53                   	push   %ebx
  8010f9:	50                   	push   %eax
  8010fa:	68 29 26 80 00       	push   $0x802629
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011ad:	53                   	push   %ebx
  8011ae:	50                   	push   %eax
  8011af:	68 ec 25 80 00       	push   $0x8025ec
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80141c:	68 5c 26 80 00       	push   $0x80265c
  801421:	68 63 26 80 00       	push   $0x802663
  801426:	6a 7c                	push   $0x7c
  801428:	68 78 26 80 00       	push   $0x802678
  80142d:	e8 24 0a 00 00       	call   801e56 <_panic>
	assert(r <= PGSIZE);
  801432:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801437:	7e 16                	jle    80144f <devfile_read+0x65>
  801439:	68 83 26 80 00       	push   $0x802683
  80143e:	68 63 26 80 00       	push   $0x802663
  801443:	6a 7d                	push   $0x7d
  801445:	68 78 26 80 00       	push   $0x802678
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801528:	68 8f 26 80 00       	push   $0x80268f
  80152d:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015d8:	50                   	push   %eax
  8015d9:	56                   	push   %esi
  8015da:	68 96 26 80 00       	push   $0x802696
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801872:	68 ae 26 80 00       	push   $0x8026ae
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c18:	68 ba 26 80 00       	push   $0x8026ba
  801c1d:	68 63 26 80 00       	push   $0x802663
  801c22:	6a 62                	push   $0x62
  801c24:	68 cf 26 80 00       	push   $0x8026cf
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801c65:	68 db 26 80 00       	push   $0x8026db
  801c6a:	68 63 26 80 00       	push   $0x802663
  801c6f:	6a 6d                	push   $0x6d
  801c71:	68 cf 26 80 00       	push   $0x8026cf
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ce3:	68 e7 26 80 00       	push   $0x8026e7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e72:	56                   	push   %esi
  801e73:	50                   	push   %eax
  801e74:	68 f4 26 80 00       	push   $0x8026f4
  ...
  801e85:	e8 66 e2 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801e8a:	c7 04 24 9c 22 80 00 	movl   $0x80229c,(%esp)
