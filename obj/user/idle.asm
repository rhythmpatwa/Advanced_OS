...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 80 	movl   $0x802280,0x803000
  800040:	22 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 8f 22 80 00       	push   $0x80228f
  800114:	6a 23                	push   $0x23
  800116:	68 ac 22 80 00       	push   $0x8022ac
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 8f 22 80 00       	push   $0x80228f
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 8f 22 80 00       	push   $0x80228f
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 ac 22 80 00       	push   $0x8022ac
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 8f 22 80 00       	push   $0x80228f
  800219:	6a 23                	push   $0x23
  80021b:	68 ac 22 80 00       	push   $0x8022ac
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 8f 22 80 00       	push   $0x80228f
  80025b:	6a 23                	push   $0x23
  80025d:	68 ac 22 80 00       	push   $0x8022ac
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 8f 22 80 00       	push   $0x80228f
  80029d:	6a 23                	push   $0x23
  80029f:	68 ac 22 80 00       	push   $0x8022ac
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 8f 22 80 00       	push   $0x80228f
  8002df:	6a 23                	push   $0x23
  8002e1:	68 ac 22 80 00       	push   $0x8022ac
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 8f 22 80 00       	push   $0x80228f
  800343:	6a 23                	push   $0x23
  800345:	68 ac 22 80 00       	push   $0x8022ac
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044b:	ba 38 23 80 00       	mov    $0x802338,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800476:	51                   	push   %ecx
  800477:	50                   	push   %eax
  800478:	68 bc 22 80 00       	push   $0x8022bc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006a0:	53                   	push   %ebx
  8006a1:	50                   	push   %eax
  8006a2:	68 fd 22 80 00       	push   $0x8022fd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800775:	53                   	push   %ebx
  800776:	50                   	push   %eax
  800777:	68 19 23 80 00       	push   $0x802319
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80082a:	53                   	push   %ebx
  80082b:	50                   	push   %eax
  80082c:	68 dc 22 80 00       	push   $0x8022dc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a99:	68 4c 23 80 00       	push   $0x80234c
  800a9e:	68 53 23 80 00       	push   $0x802353
  800aa3:	6a 7c                	push   $0x7c
  800aa5:	68 68 23 80 00       	push   $0x802368
  800aaa:	e8 24 0a 00 00       	call   8014d3 <_panic>
	assert(r <= PGSIZE);
  800aaf:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ab4:	7e 16                	jle    800acc <devfile_read+0x65>
  800ab6:	68 73 23 80 00       	push   $0x802373
  800abb:	68 53 23 80 00       	push   $0x802353
  800ac0:	6a 7d                	push   $0x7d
  800ac2:	68 68 23 80 00       	push   $0x802368
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ba5:	68 7f 23 80 00       	push   $0x80237f
  800baa:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c55:	50                   	push   %eax
  800c56:	56                   	push   %esi
  800c57:	68 86 23 80 00       	push   $0x802386
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eef:	68 9e 23 80 00       	push   $0x80239e
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801295:	68 aa 23 80 00       	push   $0x8023aa
  80129a:	68 53 23 80 00       	push   $0x802353
  80129f:	6a 62                	push   $0x62
  8012a1:	68 bf 23 80 00       	push   $0x8023bf
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8012e2:	68 cb 23 80 00       	push   $0x8023cb
  8012e7:	68 53 23 80 00       	push   $0x802353
  8012ec:	6a 6d                	push   $0x6d
  8012ee:	68 bf 23 80 00       	push   $0x8023bf
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801360:	68 d7 23 80 00       	push   $0x8023d7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014ef:	56                   	push   %esi
  8014f0:	50                   	push   %eax
  8014f1:	68 e4 23 80 00       	push   $0x8023e4
  ...
  801502:	e8 54 00 00 00       	call   80155b <vcprintf>
	cprintf("\n");
  801507:	c7 04 24 97 23 80 00 	movl   $0x802397,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80165a:	0f be 80 07 24 80 00 	movsbl 0x802407(%eax),%eax
  801661:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801825:	50                   	push   %eax
  801826:	68 1f 24 80 00       	push   $0x80241f
  80182b:	53                   	push   %ebx
  80182c:	56                   	push   %esi
  ...
  80183d:	52                   	push   %edx
  80183e:	68 65 23 80 00       	push   $0x802365
  801843:	53                   	push   %ebx
  801844:	56                   	push   %esi
  ...
  801862:	b8 18 24 80 00       	mov    $0x802418,%eax
